...
const { primaryColor, successColor } = storeToRefs(themeStore);
</script>

<template>
  <div
    class="transition-scale pointer-events-none fixed right-0 bottom-0 left-0 z-2 flex h-150 origin-bottom duration-800 sm:h-160 lg:h-[65vh] xl:h-[75vh]"
    aria-hidden="true"
  >
    <svg
      class="h-full w-full"
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stop-color="#340B05"></stop>
          <stop offset="0.182709" stop-color="#0358F7"></stop>
          <stop offset="0.283673" stop-color="#5092C7"></stop>
          <stop offset="0.413484" stop-color="#E1ECFE"></stop>
          <stop offset="0.586565" stop-color="#FFD400"></stop>
          <stop offset="0.682722" :stop-color="successColor"></stop>
          <stop offset="0.802892" :stop-color="primaryColor"></stop>
          <stop offset="1" stop-color="#FFC0FD" stop-opacity="0"></stop>
        </linearGradient>
        <linearGradient
