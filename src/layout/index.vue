<template>
  <n-layout class="layout" :position="fixedMenu" has-sider>
    <n-layout-sider
      ...
      :inverted="inverted"
      class="!relative !z-[13] !min-h-screen !shadow-xs !transition-all !duration-200 !ease-in-out"
    >
    ...
    <n-layout :inverted="inverted">
      ...
      <n-layout
        ...
        :native-scrollbar="false"
        :class="{ 'layout-default-background': designStore.darkTheme === false }"
      >
        <div
          class="layout-content-main px-3 pb-3"
          :class="{
...
<style>
.layout-sider {
  @apply !relative !z-[13] !min-h-screen !transition-all !duration-200 ease-in-out;
}
</style>
